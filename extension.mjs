// Cockpit.js entry point. The Copilot runtime discovers an extension by its
...
if (major < 22 || (major === 22 && minor < 18)) {
  throw new Error(
    `Cockpit.js requires Node >= 22.18 for native TypeScript loading; got ${process.versions.node}.`,
  );
}
